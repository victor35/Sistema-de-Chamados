    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
             ...
             <div class="testbox2">
                        <h1 id='h1form'> Alterar Menu</h1>
                        <form id="form2" action="gerenciar_menu.do" name="form_menu" method="post">

                            <hr/>
                            <input type="hidden" name="op" value="alterar"/>      
                            <input type="hidden" name="id" value="<%= m.getId()%>"/>
                            ID<%= m.getId()%><br/>
                            <input type="text" name="titulo" id="input3" placeholder="Titulo" value="<%= m.getTitulo()%>" required/><br><br>
                            <input type="text" name="link" id="input3" placeholder="Link" value="<%= m.getLink()%>"required><br><br>
