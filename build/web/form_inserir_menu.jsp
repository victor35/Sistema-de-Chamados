...
<div class="testbox2">
                    <h1 id="h1form"> Cadastrar Menu</h1>
                    <form id="form2" action="gerenciar_menu.do" name="form_menu" method="post">
                        <hr>
                        <input type="hidden" name="op" value="inserir"/>   
                        <input type="text" name="titulo" id="input3" placeholder="Titulo" required/><br><br>
                        <input type="text" name="link" id="input3" placeholder="Link" required><br><br>
