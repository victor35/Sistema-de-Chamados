...
<div class="testbox2">
                    <h1 id="h1form"> Cadastrar Unidade</h1>
                    <form id="form2" action="gerenciar_unidade.do" name="form_unidade" method="post">
                        <hr>
                        <input type="hidden" name="op" value="inserir"/>   
                        <input type="text" name="unidade" id="input3" placeholder="Unidade" required/><br><br>
                        <input type="text" name="endereco" id="input3" placeholder="Endereco" required /><br><br>
                        <input type="text" name="cep" id="input3" placeholder="CEP" required/><br><br>
                        <input type="text" name="telefone" id="input3" placeholder="Telefone:(somente numeros)" required/><br><br>
