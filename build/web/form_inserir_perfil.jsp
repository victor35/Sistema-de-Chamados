...
<div class="testbox2">
                    <h1 id="h1form"> Cadastrar Perfil</h1>
                    <form id="form2" action="gerenciar_perfil.do" name="form_perfil" method="post">
                        <hr>
                        <input type="hidden" name="op" value="inserir"/>   
                        <input type="text" name="nome" id="input3" placeholder="Nome" required/><br><br>
                        <textarea type="text" name="descricao"  placeholder="Descricao" required></textarea><br>
